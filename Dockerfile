...
# Disable user registration provider
COPY --chown=keycloak:keycloak kc-disable-user-registration/target/kc-disable-user-registration-1.0.0.jar \
  /opt/keycloak/providers/kc-disable-user-registration-1.0.0.jar
